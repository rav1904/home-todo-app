  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed inset-y-0 left-0 z-50 flex w-60 shrink-0 flex-col border-r border-stone-200/50 bg-white transition-transform duration-200 ease-out dark:border-stone-800/60 dark:bg-stone-900 md:static md:z-auto md:translate-x-0 ${
